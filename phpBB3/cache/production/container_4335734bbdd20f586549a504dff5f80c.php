...
class phpbb_cache_container extends \Symfony\Component\DependencyInjection\Container
{
    ...
    {
        return $this->services['config'] = new \phpbb\config\db(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['cache.driver']) ? $this->services['cache.driver'] : ($this->services['cache.driver'] = new \phpbb\cache\driver\file())) && false ?: '_'}, 'pconfig');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'pconfig_text');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('pcaptcha_questions', 'pcaptcha_answers', 'pqa_confirm');
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['filesystem']) ? $this->services['filesystem'] : ($this->services['filesystem'] = new \phpbb\filesystem\filesystem())) && false ?: '_'}, 'pext', './', 'php', ${($_ = isset($this->services['cache']) ? $this->services['cache'] : $this->getCacheService()) && false ?: '_'});
    }
    ...
    {
        return new \phpbb\notification\method\email(${($_ = isset($this->services['user_loader']) ? $this->services['user_loader'] : $this->getUserLoaderService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './', 'php', 'pnotification_emails');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, './', 'php', 'puser_notifications');
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'pprofile_fields_lang');
    }
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'pbbcodes', 'psmilies', 'pstyles', 'pwords', './styles/');
    }
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'pforums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'pforums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'pgroups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'pprivmsgs');
    ...
    {
        $this->services['text_reparser.poll_option'] = $instance = new \phpbb\textreparser\plugins\poll_option(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'ppoll_options');
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'ptopics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'pposts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'pusers');
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './', 'php', 'pusers');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'tables.acl_groups' => 'pacl_groups',
            'tables.acl_options' => 'pacl_options',
            'tables.acl_roles' => 'pacl_roles',
            'tables.acl_roles_data' => 'pacl_roles_data',
            'tables.acl_users' => 'pacl_users',
            'tables.attachments' => 'pattachments',
            'tables.auth_provider_oauth_token_storage' => 'poauth_tokens',
            'tables.auth_provider_oauth_states' => 'poauth_states',
            'tables.auth_provider_oauth_account_assoc' => 'poauth_accounts',
            'tables.banlist' => 'pbanlist',
            'tables.bbcodes' => 'pbbcodes',
            'tables.bookmarks' => 'pbookmarks',
            'tables.bots' => 'pbots',
            'tables.captcha_qa_questions' => 'pcaptcha_questions',
            'tables.captcha_qa_answers' => 'pcaptcha_answers',
            'tables.captcha_qa_confirm' => 'pqa_confirm',
            'tables.config' => 'pconfig',
            'tables.config_text' => 'pconfig_text',
            'tables.confirm' => 'pconfirm',
            'tables.disallow' => 'pdisallow',
            'tables.drafts' => 'pdrafts',
            'tables.ext' => 'pext',
            'tables.extensions' => 'pextensions',
            'tables.extension_groups' => 'pextension_groups',
            'tables.forums' => 'pforums',
            'tables.forums_access' => 'pforums_access',
            'tables.forums_track' => 'pforums_track',
            'tables.forums_watch' => 'pforums_watch',
            'tables.groups' => 'pgroups',
            'tables.icons' => 'picons',
            'tables.lang' => 'plang',
            'tables.log' => 'plog',
            'tables.login_attempts' => 'plogin_attempts',
            'tables.migrations' => 'pmigrations',
            'tables.moderator_cache' => 'pmoderator_cache',
            'tables.modules' => 'pmodules',
            'tables.notification_emails' => 'pnotification_emails',
            'tables.notification_types' => 'pnotification_types',
            'tables.notifications' => 'pnotifications',
            'tables.poll_options' => 'ppoll_options',
            'tables.poll_votes' => 'ppoll_votes',
            'tables.posts' => 'pposts',
            'tables.privmsgs' => 'pprivmsgs',
            'tables.privmsgs_folder' => 'pprivmsgs_folder',
            'tables.privmsgs_rules' => 'pprivmsgs_rules',
            'tables.privmsgs_to' => 'pprivmsgs_to',
            'tables.profile_fields' => 'pprofile_fields',
            'tables.profile_fields_data' => 'pprofile_fields_data',
            'tables.profile_fields_options_language' => 'pprofile_fields_lang',
            'tables.profile_fields_language' => 'pprofile_lang',
            'tables.ranks' => 'pranks',
            'tables.reports' => 'preports',
            'tables.reports_reasons' => 'preports_reasons',
            'tables.search_results' => 'psearch_results',
            'tables.search_wordlist' => 'psearch_wordlist',
            'tables.search_wordmatch' => 'psearch_wordmatch',
            'tables.sessions' => 'psessions',
            'tables.sessions_keys' => 'psessions_keys',
            'tables.sitelist' => 'psitelist',
            'tables.smilies' => 'psmilies',
            'tables.sphinx' => 'psphinx',
            'tables.styles' => 'pstyles',
            'tables.styles_template' => 'pstyles_template',
            'tables.styles_template_data' => 'pstyles_template_data',
            'tables.styles_theme' => 'pstyles_theme',
            'tables.styles_imageset' => 'pstyles_imageset',
            'tables.styles_imageset_data' => 'pstyles_imageset_data',
            'tables.teampage' => 'pteampage',
            'tables.topics' => 'ptopics',
            'tables.topics_posted' => 'ptopics_posted',
            'tables.topics_track' => 'ptopics_track',
            'tables.topics_watch' => 'ptopics_watch',
            'tables.user_group' => 'puser_group',
            'tables.user_notifications' => 'puser_notifications',
            'tables.users' => 'pusers',
            'tables.warnings' => 'pwarnings',
            'tables.words' => 'pwords',
            'tables.zebra' => 'pzebra',
            ...
            'tables' => [
                'acl_groups' => 'pacl_groups',
                'acl_options' => 'pacl_options',
                'acl_roles' => 'pacl_roles',
                'acl_roles_data' => 'pacl_roles_data',
                'acl_users' => 'pacl_users',
                'attachments' => 'pattachments',
                'auth_provider_oauth_token_storage' => 'poauth_tokens',
                'auth_provider_oauth_states' => 'poauth_states',
                'auth_provider_oauth_account_assoc' => 'poauth_accounts',
                'banlist' => 'pbanlist',
                'bbcodes' => 'pbbcodes',
                'bookmarks' => 'pbookmarks',
                'bots' => 'pbots',
                'captcha_qa_questions' => 'pcaptcha_questions',
                'captcha_qa_answers' => 'pcaptcha_answers',
                'captcha_qa_confirm' => 'pqa_confirm',
                'config' => 'pconfig',
                'config_text' => 'pconfig_text',
                'confirm' => 'pconfirm',
                'disallow' => 'pdisallow',
                'drafts' => 'pdrafts',
                'ext' => 'pext',
                'extensions' => 'pextensions',
                'extension_groups' => 'pextension_groups',
                'forums' => 'pforums',
                'forums_access' => 'pforums_access',
                'forums_track' => 'pforums_track',
                'forums_watch' => 'pforums_watch',
                'groups' => 'pgroups',
                'icons' => 'picons',
                'lang' => 'plang',
                'log' => 'plog',
                'login_attempts' => 'plogin_attempts',
                'migrations' => 'pmigrations',
                'moderator_cache' => 'pmoderator_cache',
                'modules' => 'pmodules',
                'notification_emails' => 'pnotification_emails',
                'notification_types' => 'pnotification_types',
                'notifications' => 'pnotifications',
                'poll_options' => 'ppoll_options',
                'poll_votes' => 'ppoll_votes',
                'posts' => 'pposts',
                'privmsgs' => 'pprivmsgs',
                'privmsgs_folder' => 'pprivmsgs_folder',
                'privmsgs_rules' => 'pprivmsgs_rules',
                'privmsgs_to' => 'pprivmsgs_to',
                'profile_fields' => 'pprofile_fields',
                'profile_fields_data' => 'pprofile_fields_data',
                'profile_fields_options_language' => 'pprofile_fields_lang',
                'profile_fields_language' => 'pprofile_lang',
                'ranks' => 'pranks',
                'reports' => 'preports',
                'reports_reasons' => 'preports_reasons',
                'search_results' => 'psearch_results',
                'search_wordlist' => 'psearch_wordlist',
                'search_wordmatch' => 'psearch_wordmatch',
                'sessions' => 'psessions',
                'sessions_keys' => 'psessions_keys',
                'sitelist' => 'psitelist',
                'smilies' => 'psmilies',
                'sphinx' => 'psphinx',
                'styles' => 'pstyles',
                'styles_template' => 'pstyles_template',
                'styles_template_data' => 'pstyles_template_data',
                'styles_theme' => 'pstyles_theme',
                'styles_imageset' => 'pstyles_imageset',
                'styles_imageset_data' => 'pstyles_imageset_data',
                'teampage' => 'pteampage',
                'topics' => 'ptopics',
                'topics_posted' => 'ptopics_posted',
                'topics_track' => 'ptopics_track',
                'topics_watch' => 'ptopics_watch',
                'user_group' => 'puser_group',
                'user_notifications' => 'puser_notifications',
                'users' => 'pusers',
                'warnings' => 'pwarnings',
                'words' => 'pwords',
                'zebra' => 'pzebra',
